...
class ArchitectureDiagramCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Semantics(
      container: true,
      label: 'Architecture flowchart diagram for ${topic.title}: showing ${topic.diagramSteps.length} architectural tiers',
      child: Container(
        ...
        child: SingleChildScrollView(
          ...
          children: [
            ...
            if (onPreviousStep != null && onNextStep != null && onTogglePlay != null && onResetStep != null) ...[
              const SizedBox(height: 12),
