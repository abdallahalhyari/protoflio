...
final List<HatInfo> kHats = [
  HatInfo(
    ...
    color: Color(0xE63E2723),
    titleDesc: 'I AM A QUICK LEARNER',
    desc:
        'There is nothing I love more than learning something new! This passion inspires me to jump into complex applications with excitement instead of fear. Because I have learned "how to learn" I will be able to quickly pick up new technical integrations and teach them.',
  ),
  HatInfo(
    title: 'Communicating',
    ...
    color: Color(0xE6E65100),
    titleDesc: 'I LISTEN CAREFULLY AND RESPOND CLEARLY',
    desc:
        'I believe the key to success in any industry, career, or relationship is clear communication. Over the years, I learned that listening is the first (and arguably most important) step in great communication. Thus, I challenged myself to become a great listener, which elevated my written and verbal communication skills to an expert level. I believe my communication skills will empower me to be successful in the Solutions Engineer position.',
  ),
  HatInfo(
    title: 'Sorting',
    heroTag: 'Sorting hat',
    image: 'assets/hat.png',
    color: Color(0xE6B26A00),
  ...
  HatInfo(
    ...
    color: Color(0xE6C62828),
    titleDesc: 'I LOVE MAKING THINGS',
    desc:
        'As a mobile developer, there is nothing more rewarding than starting with an app and ending with something meaningful. This passion for creation inspires me to meet new challenges head on with enthusiasm and determination. Whether I am building an app, you will often find me completely obsessed with learning the intricate details of new creative tools.',
  ),
  HatInfo(
    title: 'Fixing',
    heroTag: 'Fixing Hat',
