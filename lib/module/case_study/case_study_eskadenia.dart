    ...
    return Scaffold(
      ...
      body: PageBackground(
        child: CaseStudyReadingCompanion(
          ...
          chapters: chapters,
          primaryAccent: AppColors.caseStudyEskadeniaPrimary,
          secondaryAccent: AppColors.caseStudyEskadeniaSecondary,
            ...
            SliverPadding(
              ...
              sliver: SliverList.list(children: [
                ...
                OutcomeGrid(
                  isDesktop: isDesktop,
                  items: const [
                    ('60 FPS', 'sustained frame rate on dense hospital data tables and medical charts'),
                    ('-35%', 'reduction in client-side crash rate across multi-hour clinical shifts'),
                    ('1,000+', 'patient and student records rendered with zero viewport latency'),
                    ('4', 'enterprise platforms deployed (HIS, Clinic, University, School)'),
                  ],
                ),
                const SizedBox(height: AppSpacing.xxl),
                KeyedSubtree(
